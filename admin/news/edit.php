            ...
            <div class="row">
                <div class="col-xl-8 col-lg-12">
                    ...
                    <div class="card card-success">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="actions.php?action=news.update&id=<?= $news['id'] ?>" method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" value="<?= $news['title'] ?>" placeholder="ادخل عنوان الخبر">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="tinymce-editor" name="content"><?= $news['content'] ?></textarea>
                                </div>
                                ...
                                <?php if ($news['image']) { ?>
                                    <div class="mt-1 mb-2 ">
                                        <img class="img-thumbnail" style="max-width: 300px;" src="../front/uploads/<?= $news['image'] ?>" />
                                    </div>

                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="deleteImage" name="deleteImage">
                                        <label class="form-check-label pr-3" for="deleteImage">حذف الصورة</label>
                                    </div>
                                <?php } ?>
                            ...
                            <div class="card-footer">
                                <button name="submit" value="1" type="submit" class="btn btn-success">تعديل الخبر</button>
                            </div>
                        </form>
                    </div>
